...
\begin{align}
\vec{x}^T\vec{x}-2\vec{O}^T\vec{x}+\vec{\| O\|}^2-\vec{r}^2=0\\
\end{align}
where \vec{O} is the origin and \vec{r} is the radius of the circle\\
we get,
\begin{align}
\vec{O}=\vec{-u}=\myvec{1\\0}\\
\vec{\| O\|}^2=1\\
\vec{\| O\|}^2-\vec{r}^2=\vec{f}=-3\\
\vec{r}^2=1+3=4\\
\vec{r}=2
\end{align}
...
where i=1,2,3.....
\begin{align}
\vec{k}_i=\pm\sqrt{\frac{\vec{u}^T\vec{u}-\vec{f}}{\vec{n}^T\vec{n}}}\\
\vec{k}_i=\pm2
\end{align}
